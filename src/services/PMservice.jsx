...
// TextScramble Component for Performance Marketing
const PerformanceMarketingTextScramble = ({ phrases = ['Performance Marketing'], interval = 1200 }) => {
    ...
    const formatText = useCallback((text) => {
        if (text === 'Performance Marketing') {
            return '<span class="performance-text">Performance&nbsp;</span> <span class="marketing-text-final"><em>Marketing</em></span>';
        }
        return text;
    }, []);
    ...
    const update = useCallback(() => {
        ...
        if (complete === queueRef.current.length) {
            ...
            if (currentPhrase === 'Performance Marketing') {
                setTimeout(() => {
    ...
    return (
        <div className="performance-marketing-text-scramble-container">
            <div
                className="performance-marketing-text"
...
const MarketingServicesSection = () => {
    ...
    const MarketingGrowthAnimation = () => {
        ...
        if (infinityImages.length === 0) {
            return (
                <div className="marketing-faq-img-container">
                    <div style={{ 
                        position: 'absolute', 
                        top: '50%', 
                        left: '50%', 
    ...
    return (
        <section className="marketing-services-section">
            <div className="marketing-services-header">
                ...
                <PerformanceMarketingTextScramble phrases={['Performance Marketing']} interval={1200} />
            </div>
