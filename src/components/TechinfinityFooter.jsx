...
const VariableProximity = forwardRef((props, ref) => {
        ...
        settingsStr.split(",")
          ...
          .map(s => {
            ...
            if (parts.length >= 2) {
              ...
              const value = parseFloat(parts.slice(1).join(" "));
              return [name, value];
            }
            return null;
          })
  ...
  }, [containerRef, mousePositionRef, parsedSettings, calculateDistance, calculateFalloff, radius, fromFontVariationSettings]);
